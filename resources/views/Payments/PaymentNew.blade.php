<x-layout>
    <div class="d-flex flex-column w-100 min-vh-100 align-items-center">
        <div class="d-flex w-50 flex-column bg-light mx-auto my-auto rounded-5">
                ...
                <form class="d-flex flex-column" method="POST" action="/payments">
                    @csrf
                    @method('PUT')
                    ...
                    <x-informationCardField class="mt-3 mb-2">
                        <x-slot name="leftSide">
                            ...
                            <x-informationCardInput
                                label="Expiration Date" class="w-100" placeholder="31/03/2026" inputType="date" varName="expiration_Date">
                            </x-informationCardInput>
                            <x-errorValidationLabel name="expiration_Date"></x-errorValidationLabel>
                        </x-slot>
                        <x-slot name="rightSide">
                            <x-informationCardInput
                                label="Card Number" placeholder="Card Number" inputType="text" varName="cardNumber">
                            </x-informationCardInput>
                            <x-errorValidationLabel name="cardNumber"></x-errorValidationLabel>
                            <x-informationCardInput
                                label="Billing Address" placeholder="Billing Address" inputType="text" varName="billingAddress">
                            </x-informationCardInput>
